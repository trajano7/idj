...
class Collision {
	...
	public:
		...
		static inline bool IsColliding(Rect& a, Rect& b, float angleOfA, float angleOfB) {
			//SDL_Log("A e B %f %f %f %f | %f %f %f %f",a.x,a.y,a.w,a.h,b.x,b.y,b.w,b.h)
			...
			for (auto& v : A) {
				v = Rotate(v - a.RectCenter(), angleOfA) + a.RectCenter();
			}

			for (auto& v : B) {
				v = Rotate(v - b.RectCenter(), angleOfB) + b.RectCenter();
			}
